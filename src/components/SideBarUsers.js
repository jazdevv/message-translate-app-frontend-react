...
function SideBarUsers({rooms}){
    ...
    return ( 
        <>
        <aside className="w-16 xs:w-16 md:w-64 xl:w-96 h-screen " >
            <div className="h-full p-1 md:py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800 flex flex-col gap-2">
                <div className="flex px-4 flex-col xl:flex-row gap-2">
                    ...
                    <div className="flex gap-2 font-bold grow xl:justify-center cursor-pointer">
                        ...
                        <div className="grow xl:grow-0 hidden md:block">
                          NEW CHAT
                        </div>
